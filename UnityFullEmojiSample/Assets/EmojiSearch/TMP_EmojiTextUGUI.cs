...
namespace Kyub.EmojiSearch.UI
{
...
#endif
    {
...
#if TMP_NEW_PREPROCESSOR
        [SerializeField] protected ITextPreprocessor m_SecondaryPreprocessor;
#endif
        ...
        protected internal bool IsInputParsingRequired_Internal
        {
            get
            {
                ...
                if (_isInputParsingRequired_Field == null)
                    _isInputParsingRequired_Field = typeof(TMP_Text).GetField("m_isInputParsingRequired",
        ...
        protected TextInputSources InputSource_Internal
        {
            get
            {
                ...
                if (_inputSource_Field == null)
                    _inputSource_Field = typeof(TMP_Text).GetField("m_inputSource",
                        System.Reflection.BindingFlags.Instance | System.Reflection.BindingFlags.NonPublic);

                if (_inputSource_Field != null)
                    return (TextInputSources)System.Enum.ToObject(typeof(TextInputSources),
                        (int)_inputSource_Field.GetValue(this));
                else
            ...
            set
            {
                ...
                if (_inputSource_Field != null)
                {
                    ...
                    if (_textInputSources_Type == null)
                        _textInputSources_Type = typeof(TMP_Text).GetNestedType("TextInputSources",
        ...
        protected virtual bool ApplyMonoSpacingValues(string text, out string outText)
        {
            ...
            {
                outText = "<mspace=" + m_monospaceDistEm.ToString(System.Globalization.CultureInfo.InvariantCulture) +
                          "em>" + text;
                sucess = true;
            }
            else
        ...
        protected override Vector2 CalculatePreferredValues(ref float defaultFontSize, Vector2 marginSize,
            bool ignoreTextAutoSizing, bool isWordWrappingEnabled)
        {
            if (_emojiParsingRequired)
                ParseInputTextAndEmojiCharSequence();

            return base.CalculatePreferredValues(ref defaultFontSize, marginSize, ignoreTextAutoSizing,
 ...
 m_TextWrappingMode == TextWrappingModes.Normal || m_TextWrappingMode == TextWrappingModes.NoWrap ? TextWrappingModes.NoWrap : TextWrappingModes.PreserveWhitespaceNoWrap;
...
#if (TMP_2_2_0_PREVIEW_1_OR_NEWER && !TMP_3_0_0_OR_NEWER) || TMP_3_2_0_PREVIEW_1_OR_NEWER
                preferredHeight =
 CalculatePreferredValues(ref fontSize, margin, m_enableAutoSizing, m_TextWrappingMode).y;
#else
                preferredHeight =
                    CalculatePreferredValues(ref fontSize, margin, m_enableAutoSizing, m_enableWordWrapping).y;
#endif
